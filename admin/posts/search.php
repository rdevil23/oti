...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['entrant-search'])){
    $list = seacrhInTitileAndContent($_POST['entrant-search'], 'entrant');
}
?>
...
<table class="iksweb">
    ...
    <tr>
        ...
        <td rowspan="4"><div class="red col-1"><a href="edit.php?id=--><?//=$post['id_entrant'];?><!--">изменить</a></div></td>
