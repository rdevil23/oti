...
<head>
    ...
    <title>Редактирование информации об абитуриенте</title>
        ...
        <div class="col-75">
            <div class="container">
                <form action="edit.php" method="post">
                    <input id="id_entrant" name="id_entrant" value="<?=$id_entrant;?>" type="hidden">
                    <div class="row">
                        <div class="col-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-15">
                                    <label>
                                        ...
                                        Согласен на зачисление:<input type="checkbox" class="checkbox_style" name="consent1">
                                        Нуждается в общежитии:<input type="checkbox" class="checkbox_style" name="dormitory1">
                                        Целевое направление:<input type="checkbox" class="checkbox_style" name="target1">
                                        Подал оригинал:<input type="checkbox" class="checkbox_style" name="original1">
                                    </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    ...
                                    <input type="text" id="specialty_name" name="specialty_name1" placeholder="Название специальности">
                                </div>
                                <div class="col-5">
                                    <label for="specialty_code">Код специальности</label>
                                    <input type="text" id="specialty_code" name="specialty_code1" class="mask-specialty form-control" placeholder="xx.xx.xx">
                                </div>
                                <div class="col-5">
                                    <label for="degree_name">Уровень образования:</label>
                                    <input type="text" id="degree_name" name="degree_name1" placeholder="Бакалавриат/специалитет/...">
                                </div>
                            </div>
                            <br><hr><br>
                    ...
                    <input type="submit" value="Сохранить" name="entrant-edit" class="btn">
                </form>
            </div>
        </div>
    </div>
